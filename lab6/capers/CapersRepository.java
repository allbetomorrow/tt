...
public class CapersRepository {
    ...
    static final File CAPERS_FOLDER = Utils.join(CWD, ".capers"); // TODO Hint: look at the `join`
                                            //      function in Utils
    static final File STORY_FILE = new File(".capers/story");
    /**
    ...
    public static void writeStory(String text) {
        // TODO
        String story = Utils.readContentsAsString(Utils.join(CAPERS_FOLDER, "story")) + text + "\n";
        Utils.writeContents(Utils.join(CAPERS_FOLDER, "story"), story);
